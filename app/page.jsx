        ...
        >
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br />{" "}
              <span className="text-accent">Mbori Brandon</span>
            </h1>
            ...
            <div className="flex flex-col xl:flex-row items-center gap-8 ">
              ...
              >
                <a
                  href="/assets/MTBNCV-en.pdf"
                  download="MboriBrandonCV-English"
                >
              ...
              >
                <a
                  href="/assets/MTBNCV-fr.pdf"
                  download="MboriBrandonCV-Francais"
                >
