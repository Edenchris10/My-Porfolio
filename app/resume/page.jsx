...
const about = {
  title: 'About Me',
  description:"Below is outlined my personal information!", 
  info: [
    {
      fieldName: "Name",
      fieldValue: "Mbori Brandon",
    },
    {
      fieldName: "Phone",
    ...
    {
      fieldName: "Email",
      fieldValue: "mboribrandon@gmail.com",
    }, 
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  items: [
    ...
    {
      company: "Media Ads",
      position: "Digital Marketer/Media Buyer",
      duration: "2022 - Present",
    },  
    {
  ...
  items: [
   {
    ...
    {
      institution: " Wynbrooke Advertising Academy ",
      degree: " Certified Media Buyer",
      duration: "2025",
    },
    {
      institution: "IUGET University-Douala",
...
const skills = {
  title:"My skills",
  description: "Below is an outline of the skills i showcase!",
  skillList: [
   {
     icon: <FaHtml5 />,
     name: "HTML 5",
